...
The shebang line specifies its location, i.e., */usr/bin/python*. This is particularly useful when we [run a python program directly at command-line](#running-python-program-directly-at-command-line).
