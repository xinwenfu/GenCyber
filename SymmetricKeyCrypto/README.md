...
**Notes**: To copy the message from the chat client, use mouse to select/highlight the message and right click on it. Choose "Copy" to copy it. Now you can paste the copied message to somewhere.
