...
- *<a href="https://wiki.openssl.org/index.php/Enc">openssl enc</a>*: *Enc* is used for block and stream ciphers using password based keys or explicitly provided keys. Can used for Base64 encoding or decoding.
