...
## Lab environment
Refer to <a href="https://github.com/xinwenfu/GenCyber/tree/main/LabEnvironment">lab environment</a>. The lab environment can be set up on a personal computer.
