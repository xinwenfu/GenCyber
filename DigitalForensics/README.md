...
For a large iamge file, the analysis may take some time. Please wait for the analysis to finish. It is indicated on the status bar, which shall show 100% at the bottom.
